$(function() {
  ...
  $.plot($('#flotPie'), [
    { label: 'Nairobi', data: 77 },
    { label: 'Eastern', data: 81 },
    { label: 'Western', data: 46 },
    { label: 'Southern', data: 35 },
    { label: 'Northern', data: 79 },
    { label: 'SouthEastern', data: 84 },
    { label: 'Coastal', data: 51 }
  ], {
    series: {
      shadowSize: 0,
      pie: {
